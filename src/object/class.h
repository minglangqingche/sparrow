...
#define I32_TO_VALUE(i)         ((Value){.type = VT_I32, .ival = (i)})
#define F64_TO_VALUE(f)         ((Value){.type = VT_F64, .fval = (f)})
#define OBJ_TO_VALUE(obj)       ((Value){.type = VT_OBJ, .header = (ObjHeader*)(obj)})

#define VALUE_TO_BOOL(v)        ((v).type == VT_TRUE ? true : false)
#define VALUE_TO_I32(v)         ((v).ival)
#define VALUE_TO_F64(v)         ((v).fval)
...
#define VALUE_IS_NUM(v)         (VALUE_IS_I32(v) || VALUE_IS_F64(v))
